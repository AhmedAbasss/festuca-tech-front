...
export const UploadFileForm = <T extends FormikValues>({
  ...
  return (
    <div className={`mb-3 w-full ${formikProps.submitCount ? (errorValue && touchedValue ? "has-error" : "") : ""}`}>
      ...
      <div className="relative w-full group">
        ...
        <Upload
          ...
          className={`${image ? "h-[150px!important]" : "h-[50px!important]"} w-[100%!important] rounded-md border border-base border-dashed hover:border-primary 
                    ${formikProps.submitCount ? (errorValue && touchedValue ? "border-danger !bg-danger/[0.08]" : "") : ""}`}
          type="drag"
            ...
            {upLoading ? (
              ...
              <>
                {image && !isFileUploaded ? (
                  <img
                    ...
                    src={`${fileName}`}
                    className=" w-full h-[140px!important]"
                  />
                ) : (
              ...
              <p
                className={`
                                    ...
                                    ${formikProps.submitCount ? (errorValue && touchedValue ? "text-danger" : "text-gray-400") : "text-gray-400"}
                                    `}>
      ...
      <div>{formikProps.submitCount ? errorValue && touchedValue ? <div className="mt-[2px] w-full p-1 text-sm text-danger">{errorValue}</div> : <></> : <></>}</div>
