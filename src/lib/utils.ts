...
function S3BucketDirectory(type: UploadType): string {
  switch (type) {
    case UploadType.StoreLogo: return `${Roz.RootKey}/store/logo`;
    case UploadType.StoreBackground: return `${Roz.RootKey}/store/background`;
    case UploadType.StoreCategory: return `${Roz.RootKey}/store/category`;
    case UploadType.Advertisement: return `${Roz.RootKey}/system/advertisement`;
    case UploadType.Category: return `${Roz.RootKey}/system/category`;
    case UploadType.UserImg: return `${Roz.RootKey}/system/user`;
    case UploadType.ShopperImg: return `${Roz.RootKey}/system/shopper`;
    case UploadType.Review: return `${Roz.RootKey}/system/review`;
    case UploadType.Product:
    case UploadType.ProductGroup: return `${Roz.RootKey}/product`;
    default: return "";
  }
}
