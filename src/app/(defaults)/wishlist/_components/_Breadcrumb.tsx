              ...
              <div className="min-[768px]:w-[50%] min-[576px]:w-full w-full px-[12px]">
                <ul className="bb-breadcrumb-list mx-[-5px] flex justify-end max-[767px]:justify-center">
                  <li className="bb-breadcrumb-item text-[14px] font-normal px-[5px]">
                    <Link href="/">
                      <span className="font-Poppins text-[14px] leading-[28px] tracking-[0.03rem] font-semibold text-[#686e7d]">Home</span>
                    </Link>
                  </li>
                  <li className="text-[14px] font-normal px-[5px]">
                    <i className="ri-arrow-right-double-fill text-[14px] font-semibold leading-[28px]"></i>
                  </li>
                  <li className="bb-breadcrumb-item font-Poppins text-[#686e7d] text-[14px] leading-[28px] font-normal tracking-[0.03rem] px-[5px] active">Product Page</li>
                </ul>
              </div>
            </div>
          </div>
