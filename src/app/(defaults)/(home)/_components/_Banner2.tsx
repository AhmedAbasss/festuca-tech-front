...
const Banner2: React.FC = () => {
  return (
    <section className="section-banner-two my-[50px] max-[1199px]:my-[35px] bg-[url('/assets/images/banner.jpg')] min-h-[600px] overflow-hidden bg-no-repeat bg-cover bg-center max-[991px]:max-h-[400px] max-[991px]:min-h-[auto]">
        ...
        <div className="flex flex-wrap w-full">
          <div className="w-full px-[12px] banner-justify-box-contact h-[600px] flex justify-end items-end max-[991px]:h-[400px]">
            <div className="banner-two-box bg-[#fff] rounded-t-[30px] max-w-[400px] pt-[30px] px-[30px] flex flex-col items-start relative max-[991px]:max-w-[250px] max-[575px]:my-[0] max-[575px]:mx-[auto]">
              <span className="text-[20px] font-semibold text-[#6c7fd8] leading-[26px] max-[991px]:text-[16px]">25% Off</span>
              <h4 className="font-quicksand mb-[20px] text-[40px] font-bold text-[#3d4750] tracking-[0.03rem] leading-[1.2] max-[991px]:text-[22px]">Fresh & Organic vegetables</h4>
              <Link
