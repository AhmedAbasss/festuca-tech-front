...
const ProductCard: React.FC<ProductCardProps> = ({ image, hoverImage, label, category, title, newPrice, oldPrice, weight, rating, actions }) => {
  return (
    ...
    // <div className="w-full" data-aos="fade-up" data-aos-duration="1000" data-aos-delay="1000">
    ...
    //         <span className="text-[14px] text-[#777] font-medium uppercase"></span>
    //       </span>
    //       {/* <Link rel="noopener noreferrer" href={`/${ItemProps.id}`} scroll={false} prefetch={false}> */}
    //       <Link rel="noopener noreferrer" href={`/#`} scroll={false} prefetch={false}>
    //         <div className="inner-img relative block overflow-hidden pointer-events-none rounded-t-[20px]">
...
export const DealSection2 = () => {
  // const DealSection2 = await getDealSection2();
